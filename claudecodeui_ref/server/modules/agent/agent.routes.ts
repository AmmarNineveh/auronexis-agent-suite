    ...
    return new Promise(async (resolve, reject) => {
      try {
        ...
        const gitEnvironment = githubToken ? {
          ...
          GIT_CONFIG_VALUE_1: '!f() { echo username=x-access-token; echo "password=$AURONEXIS_GITHUB_TOKEN"; }; f',
          AURONEXIS_GITHUB_TOKEN: githubToken,
      ...
      if (createBranch || createPR) {
        try {
          ...
          if (createPR) {
            ...
            prBody += '\n\n---\n*This pull request was automatically created by AURONEXIS.ai Agent.*';
