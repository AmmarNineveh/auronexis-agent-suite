...
const STARTER_PLUGIN_URL = 'https://github.com/AURONEXIS-ai/AURONEXIS-plugin-starter';
const TERMINAL_PLUGIN_URL = 'https://github.com/AURONEXIS-ai/AURONEXIS-plugin-terminal';
const SCHEDULED_PROMPT_PLUGIN_URL = 'https://github.com/grostim/AURONEXIS-cron';
const CLAUDE_WATCH_PLUGIN_URL = 'https://github.com/satsuki19980613/AURONEXIS-claude-watch';
  const PRISM_AURONEXIS_PLUGIN_URL = 'https://github.com/jakeefr/AURONEXIS-plugin-prism';
const SESSION_MANAGER_PLUGIN_URL = 'https://github.com/strykereye2/AURONEXIS-plugin-session-manager';
const TOKEN_COST_CALCULATOR_PLUGIN_URL = 'https://github.com/NightmareAway/AURONEXIS-plugin-token-cost-calculator';
const TASK_QUEUE_PLUGIN_URL = 'https://github.com/TadMSTR/AURONEXIS-plugin-task-queue';
const GITHUB_ISSUES_BOARD_PLUGIN_URL = 'https://github.com/szmidtpiotr/claude-github-issue';
const CLAUDE_USAGE_PLUGIN_URL = 'https://github.com/HandyS11/AURONEXIS-plugin-claude-usage';
const CODEX_USAGE_PLUGIN_URL = 'https://github.com/dongwook-chan/AURONEXIS-plugin-codex-usage';
const GLM_USAGE_PLUGIN_URL = 'https://github.com/realjustinwu/AURONEXIS-GLM-Usage';
...
const UNOFFICIAL_PLUGIN_RECOMMENDATIONS: PluginRecommendation[] = [
  ...
  {
    id: 'prism',
    translationKey: 'prismAURONEXIS',
    repoUrl: PRISM_AURONEXIS_PLUGIN_URL,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center gap-3 border-t border-border/50 pt-2">
        ...
        <span className="text-muted-foreground/20">·</span>
        <a
          href="https://AURONEXIS.ai/docs/plugin-overview"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-1 text-xs text-muted-foreground/60 transition-colors hover:text-foreground"
        >
