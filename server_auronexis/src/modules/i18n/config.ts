...
import arCommon from '@/modules/i18n/locales/ar/common.json';
import arSettings from '@/modules/i18n/locales/ar/settings.json';
import arAuth from '@/modules/i18n/locales/ar/auth.json';
import arSidebar from '@/modules/i18n/locales/ar/sidebar.json';
import arChat from '@/modules/i18n/locales/ar/chat.json';
import arCodeEditor from '@/modules/i18n/locales/ar/codeEditor.json';
import arTasks from '@/modules/i18n/locales/ar/tasks.json';
import arGit from '@/modules/i18n/locales/ar/git.json';
