...
const GITHUB_ISSUES_URL = 'https://github.com/AmmarNineveh/auronexis-agent-suite/issues';
const GITHUB_REPO_URL = 'https://github.com/AmmarNineveh/auronexis-agent-suite';
    ...
    <div className="flex-shrink-0" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0)' }}>
      ...
      {!IS_PLATFORM && (
        <div className="hidden px-3 py-2 text-center md:block">
          ...
          >
            AURONEXIS v{currentVersion} – {t('branding.openSource')}
          </a>
        </div>
      )}
