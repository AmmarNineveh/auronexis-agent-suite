...
import { AURONEXIS_WORDMARK_FONT_FAMILY } from '@/shared/constants';
import { IS_PLATFORM } from '@/shared/utils';
import { useVersionCheck } from '@/shared/hooks/useVersionCheck';
import PremiumFeatureCard from '@/modules/settings/PremiumFeatureCard';

const GITHUB_REPO_URL = 'https://github.com/AURONEXIS-team/claudecodeui';
const DISCORD_URL = 'https://discord.gg/buxwujPNRE';
const DOCS_URL = 'https://AURONEXIS.ai/docs/plugin-overview';
const AURONEXIS_URL = 'https://AURONEXIS.ai';
...
export default function AboutTab() {
  ...
  const { updateAvailable, latestVersion, currentVersion, releaseInfo } = useVersionCheck('AURONEXIS-team', 'claudecodeui');
        ...
        <div>
          <div className="flex items-center gap-2">
            <span
              ...
              style={{ fontFamily: AURONEXIS_WORDMARK_FONT_FAMILY }}
            >
              AURONEXIS
            </span>
            <a
