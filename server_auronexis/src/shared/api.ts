...
export const api = {
  ...
  // Chat attachments, stored globally under ~/.Auronexis/assets
  assets: {
 ...
 * voice helpers below, which bypass the AURONEXIS proxy when a base URL is configured.
 */
 ...
 * endpoint when one is set and otherwise going through the AURONEXIS voice proxy.
 */
 ...
 * endpoint when one is set and otherwise the AURONEXIS voice proxy.
 */
