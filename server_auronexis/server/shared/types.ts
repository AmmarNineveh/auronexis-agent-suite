...
export type ProviderModelOption = {
  ...
  recordId?: number;
  /** True for user-created rows; false for immutable AURONEXIS defaults. */
  isCustom?: boolean;
  effort?: {
    default?: string;
    values: {
 ...
 * checked out in the main worktree), last-commit metadata, and the AURONEXIS
...
/**
 * Input accepted when registering an existing worktree as a AURONEXIS project.
 *
...
/**
 * Project view returned after a worktree is opened in AURONEXIS.
 *
