...
test('Codex synchronizer preserves the title assigned when AURONEXIS creates a session', { concurrency: false }, async () => {
  ...
  try {
    ...
    await withIsolatedDatabase(async () => {
      ...
      // exactly as a message sent from AURONEXIS does.
